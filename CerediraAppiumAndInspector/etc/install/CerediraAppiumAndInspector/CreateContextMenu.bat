...
call :CreateApp "%root%" "AppiumCmd" "AppiumCmd" "%ceredira_path%\AppiumCmd.bat" "%ComSpec%"
call :CreateApp "%root%" "AppiumInspector" "AppiumInspector" "%ceredira_path%\AppiumInspector.bat" "%ComSpec%"
call :CreateApp "%root%" "AppiumService_UIAutomator2" "AppiumService_UIAutomator2" "%ceredira_path%\AppiumService_UIAutomator2.bat" "%ComSpec%"
call :CreateApp "%root%" "AppiumService_XCUITest" "AppiumService_XCUITest" "%ceredira_path%\AppiumService_XCUITest.bat" "%ComSpec%"
call :CreateApp "%root%" "AppiumServiceDefault" "AppiumServiceDefault" "%ceredira_path%\AppiumServiceDefault.bat" "%ComSpec%"
call :CreateApp "%root%" "AppiumServiceDocs" "AppiumServiceDocs" "%ceredira_path%\AppiumServiceDocs.bat" "%ComSpec%"
