...
call :CreateApp "%root%" "Everything" "Everything" "%ceredira_path%\Everything.bat" "%ceredira_path%\bin\Everything\Everything.exe"
call :CreateApp "%root%" "FindAndReplace" "FindAndReplace" "%ceredira_path%\FindAndReplace.bat" "%ceredira_path%\bin\FindAndReplace\fnr.exe"
call :CreateApp "%root%" "KeePass" "KeePass" "%ceredira_path%\KeePass.bat" "%ceredira_path%\bin\KeePass\KeePass.exe"
