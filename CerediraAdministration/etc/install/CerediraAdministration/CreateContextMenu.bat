...
call :CreateApp "%root%" "LdapAdmin" "LdapAdmin" "%ceredira_path%\LdapAdmin.bat" "%ceredira_path%\bin\LdapAdmin\LdapAdmin.exe"
call :CreateApp "%root%" "MultiCommander" "MultiCommander" "%ceredira_path%\MultiCommander.bat" "%ceredira_path%\bin\MultiCommander\MultiCommander.exe"
call :CreateApp "%root%" "Nssm" "Nssm" "%ceredira_path%\Nssm.bat" "%ceredira_path%\bin\Nssm\Nssm.exe"
call :CreateApp "%root%" "PsTools" "PsTools" "%ceredira_path%\PsTools.bat" "%ceredira_path%\bin\PsTools\PsExec.exe"
call :CreateApp "%root%" "Scanner" "Scanner" "%ceredira_path%\Scanner.bat" "%ceredira_path%\bin\Scanner\Scanner.exe"
